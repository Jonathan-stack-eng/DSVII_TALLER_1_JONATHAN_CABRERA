...
function calcularCrecimiento($ventas) {
    ...
    $ultimaVenta = end($ventas); // Último valor del array
    return (($ultimaVenta - $primeraVenta) / $primeraVenta) * 100;
}

// 9. Función para encontrar el producto y la región con mayor crecimiento
function analizarCrecimientoVentas($ventas) {
    ...
    return [$productoTop, $regionTop, $mayorCrecimiento];
}

// 10. Mostrar el crecimiento de ventas y el producto con mayor crecimiento
[$productoConMayorCrecimiento, $regionConMayorCrecimiento, $crecimientoMaximo] = analizarCrecimientoVentas($ventas);

echo "Producto con mayor crecimiento: $productoConMayorCrecimiento en la región $regionConMayorCrecimiento ";
echo "(" . number_format($crecimientoMaximo, 2) . "% de crecimiento)\n";
