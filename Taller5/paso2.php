...
// Crear una función que encuentre y retorne el producto con el mayor valor total en inventario
function productoMayorValor($inv) {
    ...
    return ["producto" => $mayorProducto, "valor_total" => $mayorValor];
}

//  Mostrar el producto con mayor valor en inventario
$mayor = productoMayorValor($inventario);
echo "\nEl producto con mayor valor en inventario es: {$mayor['producto']} con un valor total de \${$mayor['valor_total']}\n";
